...
{
    public partial class FrmNuevaSeccion : Form
    {
        ...
        public FrmNuevaSeccion(int gradoId, string nombreGrado, string nivel)
        {
            InitializeComponent();
        ...
        {
            using FrmNuevoGrado frm = new FrmNuevoGrado(_gradoId, _nombreGrado, _nivel);
