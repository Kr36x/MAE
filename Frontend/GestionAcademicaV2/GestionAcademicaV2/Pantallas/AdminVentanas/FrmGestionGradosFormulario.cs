...
namespace GestionAcademicaV2.Pantallas.AdminVentanas
{
    ...
    public partial class FrmGestionGradosFormulario : Form
    {
        ...
        public FrmGestionGradosFormulario()
        {
            InitializeComponent();
        ...
        // MODO: SOLO SECCION
        public FrmGestionGradosFormulario(int gradoId, string nombreGrado, string nivel)
        {
            InitializeComponent();
