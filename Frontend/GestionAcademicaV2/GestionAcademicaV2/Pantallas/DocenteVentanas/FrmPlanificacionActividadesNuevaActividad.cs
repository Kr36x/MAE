...
{
    public partial class FrmPlanificacionActividadesNuevaActividad : Form
    {
        ...
        public FrmPlanificacionActividadesNuevaActividad(int cargaId, int parcial, DataTable dtActividadesActuales)
        {
            InitializeComponent();
            _cargaId = cargaId;
            _parcial = parcial;
