...
namespace GestionAcademicaV2.Pantallas.DocenteVentanas
{
    ...
    public partial class FrmAdminConsolidadoAsignaturas : Form
    {
        ...
        public FrmAdminConsolidadoAsignaturas()
        {
            InitializeComponent();
            AplicarColoresUI();
        ...
        private void btnAmpliarGrafico_Click(object sender, EventArgs e)
        {
            ...
            FrmConsolidadoAsignaturasGraficoAmpliado frm = new FrmConsolidadoAsignaturasGraficoAmpliado(
                dtGraficoCompleto
            );
