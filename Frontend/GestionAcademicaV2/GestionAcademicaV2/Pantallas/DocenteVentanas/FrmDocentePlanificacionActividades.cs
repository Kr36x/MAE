...
namespace GestionAcademicaV2.Pantallas.DocenteVentanas
{
    public partial class FrmPlanifacacionActividades : Form
    {
        ...
        private void btnNuevaActividad_Click(object sender, EventArgs e)
        {
            ...
            using (FrmPlanificacionActividadesNuevaActividad frm = new FrmPlanificacionActividadesNuevaActividad(
        ...
        private void EditarActividad(int actividadId)
        {
            try
            {
                ...
                using (FrmPlanificacionActividadesEditarActividad frm = new FrmPlanificacionActividadesEditarActividad(
                    actividadId,
                    descripcionActual,
                    valorActual,
                    docenteId,
