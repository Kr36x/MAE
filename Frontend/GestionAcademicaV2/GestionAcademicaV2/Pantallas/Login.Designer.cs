namespace GestionAcademicaV2.Pantallas
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6.Location = new Point(410, 29);
            label6.Name = "label6";
            ...
            label5.TabIndex = 10;
            label5.Text = "Inicie sesión para continuar";
            ...
            label1.Location = new Point(309, 95);
            label1.Name = "label1";
            ...
            LoginBoton.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            LoginBoton.FillColor = SystemColors.HotTrack;
            LoginBoton.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold);
            ...
            label2.Location = new Point(309, 162);
            label2.Name = "label2";
            ...
            label3.Font = new Font("Segoe UI Semibold", 20F, FontStyle.Bold | FontStyle.Italic);
            label3.ForeColor = SystemColors.HotTrack;
            label3.Location = new Point(165, -6);
            label3.Name = "label3";
            ...
            label4.Name = "label4";
            label4.Size = new Size(600, 37);
            label4.TabIndex = 10;
            label4.Text = "Sistema de Monitoreo, Aprendizaje y Evaluación";
            // 
            // Login
            // 
